...
game_dictionary = merge_jsons([
    ...
    f"{dqx_translations_path}/subPackage41Client.json",
    f"{dqx_translations_path}/smldt_msg_pkg_STAGE_ID.json",
    f"{dqx_translations_path}/smldt_msg_pkg_LOCATIONTITLE.json",
    f"{dqx_translations_path}/subPackage02Client.json",
    f"{dqx_translations_path}/smldt_msg_pkg_NPC_DB.json",
    f"{dqx_translations_path}/subPackage68Client.json",
    f"{dqx_translations_path}/smldt_msg_pkg_PC_SAVE_POPPOINT_NAME.json",
    f"{dqx_translations_path}/subPackage127Client.json",
    f"{dqx_translations_path}/subPackage128Client.json",
    f"{dqx_translations_path}/subPackage61Client.json",
    f"{dqx_translations_path}/subPackage40Client.json",
    f"{dqx_translations_path}/subPackage12Client.json",
])
